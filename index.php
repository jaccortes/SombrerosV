				...
				<div class="cols2">
					...
					<div class="containernoti">
						<p class="textonoti">
							...
							<span class="capitaletra">E</span>l parador turístico es cubierto por un enorme sombrero vueltiao que no es de paja sino de hierro y concreto y si las...	 <button onclick="window.location.href='noticia1'">VER</button>					
						</p>
					</div>
					...
					<div class="containernoti">
						<p class="textonoti">
							...
							<span class="capitaletra">S</span>e elabora con la fibra de la caña flecha, de la cual se extrae la fibra vegetal con la que la comunidad indígena Zenú elabora Dif...		<button onclick="window.location.href='noticia2'">VER</button>						
						</p>
					</div>
				</div>
				<div class="cols3"></div>
				<div class="cols2">
					...
					<div class="containernoti">
						<p class="textonoti">
							...
							<span class="capitaletra">E</span>l sombrero vueltiao de Tuchín tiene imitación 'Made in China' Se venden más baratos, por las calles se consiguen...		<button onclick="window.location.href='noticia3'">VER</button>						
						</p>
					</div>
					<div class="containernotisepara"></div>
					<!-- noticia4 -->
					<div class="containernoti">
						<p class="textonoti">
							...
							<span class="capitaletra">A</span>sí reaccionó el papa cuando le pusieron el sombrero vueltiao en Villavicencio, aunque no es típico de la región llanera...			<button onclick="window.location.href='noticia4'">VER</button>					
						</p>
					</div>
				</div>		
				<div class="cols">
								...
								<div class="texto">
									<div class="hero-image">
									  <div class="hero-text">
										...
										Frase: Si hay más allá, hay más acá?
									  </div>
									</div>
								</div>
							</div>
